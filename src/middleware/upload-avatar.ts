...
/**
 * Run multer for the `photo` field and translate its failures into our standard
 ...
 */
export function uploadAvatarPhoto(req: Request, res: Response, next: NextFunction): void {
