...
/** Matches the frontend's `createHttpsOrSiteRelativeUrlSchema` — an asset this site may serve. */
...
/** Matches `createExternalHttpsUrlSchema` — an outbound link, where there is no same-site case. */
