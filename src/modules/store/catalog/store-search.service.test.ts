...
describe("store search enqueue helpers", () => {
  let enqueueProductSearchDocumentRefresh: typeof import("#src/modules/store/catalog/store-search.service.js").enqueueProductSearchDocumentRefresh;
  let sendJob: typeof import("#src/lib/jobs.js").sendJob;

  beforeAll(async () => {
    ({ enqueueProductSearchDocumentRefresh } = await import("#src/modules/store/catalog/store-search.service.js"));
