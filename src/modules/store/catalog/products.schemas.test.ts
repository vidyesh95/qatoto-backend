...
vi.mock("#src/modules/store/catalog/products.service.js", () => ({}));

const { CreateProductSchema, UpdateProductSchema } = await import("#src/modules/store/catalog/products.schemas.js");
