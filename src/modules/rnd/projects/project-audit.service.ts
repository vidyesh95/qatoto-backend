 ...
 *
 * ANOTHER COUNTER ON THE SAME ROW, and for the same reason the ledger counter lives here:
 * a writer that opens a period AND appends an audit entry in one transaction —
