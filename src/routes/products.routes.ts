 ...
 */
router.get("/mine", requireAuth, productsController.getMyProducts);
 ...
 */
router.delete("/:id/images/:imageId", requireAuth, productsController.deleteImage);

/**
 * POST /products/:id/publish
 * draft → active (server-side completeness gate).
 */
router.post("/:id/publish", requireAuth, productsController.publishProduct);

/**
 * POST /products/:id/unpublish
 * active → draft.
 */
router.post("/:id/unpublish", requireAuth, productsController.unpublishProduct);
